...
def delete_silence(file_path, output_filename, min_silence_to_cut_duration, padding, chunk_size=0.05):
    clear_console()
    print("Fastcut - Starting...")
    ...
    chunk_duration = chunk_size  # Duration of each chunk in seconds
    ...
    clear_console()
    print("Fastcut - Clearing anomalies...")
    ...
    clear_console()
    print("Fastcut - Searching matching silence chunks...")
    silence_chunks_list = []
